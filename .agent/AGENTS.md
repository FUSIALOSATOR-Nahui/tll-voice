...
## 2. Архитектура (v0.5.1 — Layered Core/Platform)
...
## 9. Локализация и правила оформления артефактов
